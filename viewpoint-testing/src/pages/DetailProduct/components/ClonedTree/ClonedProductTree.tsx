...
import ClonedProductTreeNode from "./ClonedProductTreeNode/ClonedProductTreeNode";
import { Wrapper } from "./ClonedProductTreeStyle";

type TreeComponentProps = {
  dataObjectTree: TreeData;
  setDataObjectTree: (__any, _newChidlren?) => void;
...
const ClonedProductTree: React.FC<TreeComponentProps> = React.forwardRef(
  (props, ref) => {
    const {
      dataObjectTree,
      setDataObjectTree,
    ...
    const confirmLockMany = () => {
      Modal.confirm({
        ...
        onOk: async () => {
          try {
            await onChangeLockedByArrayId(true);
          } catch (error) {}
        },
      });
    };
          ...
          <CustomRCTree
            ...
            titleRender={(node) => (
              <ClonedProductTreeNode
                ...
                checkHasLockedFunctionInObject={checkHasLockedFunctionInObject}
              />
            )}
          />
        </WrapperRCTree>
...
export default ClonedProductTree;
