    ...
    try {
        ...
        form.setFields([
          {
            ...
            errors: [t("validate:product.name_is_invalid")],
          },
        ]);
        return;
      }
      ...
      await requestAPI.createRequest({
        payload: {
          ...
          productIdFrom: values.from.id,
          productIdTo: values.mergeInto.id,
      ...
      } else if (error?.code === "ProductToInvalid") {
        form.setFields([
          {
            name: "mergeInto",
            errors: [t(`responseMessage:${error?.code}`)],
    ...
    if (currentProduct || open) {
      form.setFields([
        ...
        },
        {
          name: "from",
          value: {
            value: currentProduct?.detail?.name,
        ...
        },
        {
          ...
          value:
            ...
            !currentProduct?.cloneProductResponse?.isDeleted
              ? {
                  value: currentProduct?.cloneProductResponse?.detail?.name,
                  id: currentProduct?.cloneProductResponse?.id,
                }
              : "",
          errors: [],
        },
        {
          ...
          value:
            ...
            !currentProduct?.cloneProductResponse?.isDeleted
              ? {
                  value:
                    currentProduct?.cloneProductResponse?.userCreate?.account,
                  id: currentProduct?.cloneProductResponse?.userCreate?.id,
                }
              : "",
          errors: [],
        },
      ...
      <Wrapper>
        ...
        >
          ...
          <Form.Item
            ...
            name="mergeInto"
            extra={`*${t(
              "common:detail_product.only_merge_not_itself_product"
            )}`}
          >
            <AutoComplete
