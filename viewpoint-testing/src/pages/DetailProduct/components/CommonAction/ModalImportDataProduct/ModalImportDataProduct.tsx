...
import { Wrapper } from "./ModalImportDataProductStyled";
...
const ModalImportDataProduct: React.FC<ModalImportProductProps> = ({
  open,
  currentVPCollection,
  setOpen,
  getData,
  ...
  const handleOk = async (values) => {
    try {
      ...
      await productAPI.importDataLanguage({
        payload: {
          data: data,
        },
      });
      handleCancel();
      await getData();
      showSuccessNotification(t("common:product.import_data_successfully"));
      setOpen(false);
      setFile(null);
      setIsEmpty(true);
      form.resetFields();
...
export default ModalImportDataProduct;
